...
import org.squbs.chill.java.{Java8ClosureRegistrar, PackageRegistrar}
 ...
 * projects using chill for long term persistence - see org.squbs.chill.RegistrationIdsSpec.
 */
